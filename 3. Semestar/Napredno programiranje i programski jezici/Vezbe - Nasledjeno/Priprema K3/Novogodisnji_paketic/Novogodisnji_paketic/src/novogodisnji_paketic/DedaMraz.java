...
public class DedaMraz {
	...
	public ArrayList<String> sifrujNamenjen() {
		...
		for (NovogodisnjiPaketic paket : paketici.values()) {
			...
			// validno je i samo String temp = paket.getOpis();
			temp = temp.trim();
	...
	public static void main(String[] args) {
		...
		NovogodisnjiPaketic np2 = new NovogodisnjiPaketic("mala lutka", "za devojcicu", false, 3, true, false);
		...
		dm.pripremiZaIsporuku(np1, "mali voz");
		dm.pripremiZaIsporuku(np2, "mala lutka");
		dm.pripremiZaIsporuku(np3, "mali bager");
