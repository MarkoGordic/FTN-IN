...
public class Test {
	...
	public static void main(String[] args) {
		...
		// ako name dobije novu vrednost, onda ce samo name pokazivati na novu stvar, dok ce name_1 ostati na staroj
		...
		if(str.indexOf("Java") != -1){ // vraca kad pocinje taj podstring ili -1 ako nema
		...
		// moramo izgubiti specijalna znacenja za (), {}, \, |, . i tako dalje
